...
final class Lights3DExample: UIViewController {
...
struct Lights3DExampleView: View {
    var body: some View {
        Lights3DExampleMapView()
            .edgesIgnoringSafeArea(.all)
    }
}

struct Lights3DExampleMapView: UIViewRepresentable {
...
struct Lights3DExampleView_Previews: PreviewProvider {
